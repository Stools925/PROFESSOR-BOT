...
API_ID = int(environ['26990055'])
API_HASH = environ['d2bddc43b1db2d99784a99fe414157a1']
BOT_TOKEN = environ['6601426767:AAGVdaXI2LWF1HQphF3QDZ5c9AOZUJ5OIKk']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5364848614').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001987903705').split()]
