...
API_ID = int(environ['24926969'])
API_HASH = environ['21d34ab214d83d543f555396cbeecf4e']
BOT_TOKEN = environ['6362301740:AAGCi3z-6zdAVj8NZFW2a9M0ZHHdQ4enhtI']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1042029807').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002042978606', '0').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Streamplax:Streamplax@cluster0.ctmx0e9.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('-1002042978606', 0))
